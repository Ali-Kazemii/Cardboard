...
internal abstract class CardboardApiCallback<T : CardboardBaseResponse>
    : Callback<T> {
    ...
    override fun onResponse(call: Call<T>, response: Response<T>) {
        ...
        body?.let {
            ...
            failure(CardboardBaseResponse().apply {
                    ...
                    if (errorMap.containsKey(response.code())) {
                        try {
                            ...
                            val mError = gson.fromJson(
                                ...
                                CardboardBaseResponse::class.java
                            )
    ...
    abstract fun failure(response: CardboardBaseResponse? = null)
}