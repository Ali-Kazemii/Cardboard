...
internal class CaseDetailActivity : ChildActivity() {
    ...
    private fun gotoCaseDetailFragment(
        ...
        replaceFragmentInActivity(
            ...
            CaseDetailFragment.TAG
        )
    }

    private val caseDetailListener = object : CaseDetailFragment.OnActionListener {

        override fun onRefer(model: CardboardInformationResponse.Result) {
            val intent = Intent(this@CaseDetailActivity, ReferActivity::class.java)
