...
internal class FastReferFragment(
                                ...
                                override fun onDelete(ufrId: Long) {
                                    activity.showActionFlashbar(
                                        ...
                                        viewModel.deleteFastRefer(
                                            DeleteFastReferRequest().also { request ->
                                                request.ufrId = ufrId
                                                request.userId = viewModel.userId
                                                request.financialYearId = viewModel.financialYear
                                            }
    ...
    companion object {
        val TAG = "${Const.APP_NAME}: ${FastReferFragment::class.java.simpleName}"
    }
}